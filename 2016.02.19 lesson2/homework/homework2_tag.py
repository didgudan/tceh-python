...
def perform_move(field, key):
    ...
    if (key is "up"): new_position = [ current_position[0] - 1, current_position[1] ]
    elif (key is "down"): new_position = [ current_position[0] + 1, current_position[1] ]
    elif (key is "left"): new_position = [ current_position[0], current_position[1] - 1 ]
    elif (key is "right"): new_position = [ current_position[0], current_position[1] + 1 ]
...
def handle_user_input(user_input):
    ...
    # """
    # ...
    if (user_input is "w"): current_move = "up"
    elif (user_input is "s"): current_move = "down"
    elif (user_input is "a"): current_move = "left"
    elif (user_input is "d"): current_move = "right"
    elif (user_input == "exit"): raise SystemExit
    else:
        raise Exception("Не умею так ходить!")
...
def main():
    ...
    while not is_game_finished(tag_list):
        try:    
            ...
            move = handle_user_input(user_input)
